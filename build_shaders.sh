...
rm -f ./metal/tests/bigint_add_unsafe.ir
...
rm -f ./metal/tests/bigint_add_wide.ir
...
rm -f ./metal/tests/bigint_sub.ir
...
rm -f ./metal/tests/ff_sub.ir

# mont_mul_optimised.metal
xcrun -sdk macosx metal -c ./metal/tests/mont_mul_optimised.metal -o ./metal/tests/mont_mul_optimised.ir  
xcrun -sdk macosx metallib ./metal/tests/mont_mul_optimised.ir -o ./metal/tests/mont_mul_optimised.metallib
rm -f ./metal/tests/mont_mul_optimised.ir
